...
export const servicesData: ServiceData[] = [
  ...
  },
  {
    ...
    tagline: "Native & cross-platform apps, shipped to the App Store and Google Play",
    description:
      "We design and build polished iOS and Android apps — React Native and Flutter for cross-platform speed, or fully native Swift/Kotlin when performance demands it — and carry them all the way through App Store and Google Play submission, review, and launch.",
    ...
    features: [
      ...
      "Fully native builds in Swift/SwiftUI and Kotlin when raw performance matters",
      "App Store Connect & Google Play Console setup, listing, and submission",
      "Push notifications, deep linking, and background sync",
      "Offline-first architecture with local storage & sync",
      "In-app purchases, subscriptions, and payment gateway integration",
      "Biometric auth, camera, GPS, and other native device integrations",
      "Crash reporting, analytics, and CI/CD pipelines (Fastlane, EAS) for fast releases",
    ],
    techStack: ["React Native", "Flutter", "Expo", "Swift", "Kotlin", "Firebase", "Fastlane", "Supabase"],
    process: [
      { step: 1, title: "Discovery & UX Design", description: "Mapping user flows and platform-specific UX patterns (iOS Human Interface Guidelines, Material Design) into high-fidelity Figma prototypes." },
      { step: 2, title: "Cross-Platform Build", description: "Building the app with a shared codebase where it makes sense, dropping into native modules for camera, biometrics, or performance-critical screens." },
      { step: 3, title: "Device & Store QA", description: "Testing across real iOS and Android devices and OS versions, then preparing screenshots, privacy labels, and metadata for store review." },
      { step: 4, title: "Submission & Launch", description: "Handling App Store and Google Play submission end-to-end, responding to review feedback, and setting up staged rollouts with crash monitoring." },
    ],
    examples: [
      {
        title: "On-Demand Service Booking App",
        industry: "Home Services",
        description: "Cross-platform React Native app connecting customers with service providers — live booking, in-app chat, GPS tracking, and Razorpay payments, shipped to both the App Store and Play Store.",
        image: "https://images.unsplash.com/photo-1607252650355-f7fd0460ccdb?w=600&h=400&fit=crop",
        results: ["Live on iOS & Android", "Booking completion ↑ 55%", "App Store rating: 4.7/5", "Support tickets ↓ 40%"],
      },
      {
        title: "Fitness & Wellness Tracker",
        industry: "Health & Fitness",
        description: "Native-feel Flutter app with workout plans, progress tracking, wearable sync, and push-notification-driven habit streaks for a subscription fitness brand.",
        image: "https://images.unsplash.com/photo-1526498460520-4c246339dccb?w=600&h=400&fit=crop",
        results: ["10K+ downloads in month 1", "Daily active use ↑ 3x", "Subscription conversion: 22%", "Play Store rating: 4.6/5"],
      },
      {
        title: "Field Sales & Inventory App",
        industry: "Manufacturing",
        description: "Offline-first Android app for a field sales team — order capture, inventory lookup, and auto-sync once back online — replacing paper order books across 15 states.",
        image: "https://images.unsplash.com/photo-1556656793-08538906a9f8?w=600&h=400&fit=crop",
        results: ["Order entry time ↓ 65%", "Works fully offline", "15 states rolled out", "Data errors ↓ 90%"],
      },
    ],
    faqs: [
      { question: "Should we go native or cross-platform?", answer: "Cross-platform (React Native/Flutter) covers 90% of apps well and ships to both stores from one codebase, cutting cost and time roughly in half. We recommend fully native only when you need deep OS integration or peak animation performance." },
      { question: "How long does App Store/Play Store approval take?", answer: "Google Play review is usually a few hours to 1-2 days. Apple's App Store review typically takes 1-3 days, longer if there are guideline issues — we handle resubmissions and review communication for you." },
      { question: "Can you convert our existing website into an app?", answer: "Yes, though we'll usually recommend a proper native/cross-platform build over a wrapped webview for real app-store-quality performance, offline support, and native device features." },
      { question: "Do you handle app updates and store maintenance after launch?", answer: "Yes. We offer maintenance retainers covering OS/SDK updates, new feature releases, crash monitoring, and keeping up with each year's App Store and Play Store policy changes." },
    ],
  },
  {
