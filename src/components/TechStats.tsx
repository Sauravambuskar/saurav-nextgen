...
import { HiMiniRocketLaunch, HiMiniShieldCheck, HiMiniServerStack, HiMiniArrowPath, HiMiniCurrencyDollar, HiMiniGlobeAlt, HiMiniUserGroup, HiMiniStar } from "react-icons/hi2";
import type { IconType } from "react-icons";

const stats: { icon: IconType; value: number; suffix: string; label: string; description: string }[] = [
  { icon: HiMiniRocketLaunch, value: 200, suffix: "+", label: "Successful Deployments", description: "Zero-downtime releases across production environments" },
  { icon: HiMiniShieldCheck, value: 99.9, suffix: "%", label: "Uptime Achieved", description: "SLA compliance across all managed infrastructure" },
  { icon: HiMiniServerStack, value: 50, suffix: "+", label: "Servers Managed", description: "AWS EC2, EKS clusters, and Linux servers" },
  { icon: HiMiniArrowPath, value: 30, suffix: "+", label: "CI/CD Pipelines", description: "Jenkins, GitHub Actions, GitLab CI automations" },
  { icon: HiMiniCurrencyDollar, value: 60, suffix: "%", label: "Cost Reduction", description: "Infrastructure optimization & right-sizing" },
  { icon: HiMiniGlobeAlt, value: 17, suffix: "+", label: "Live Projects", description: "Production websites across 5+ industries" },
  { icon: HiMiniUserGroup, value: 10, suffix: "K+", label: "Users Served", description: "End users across all deployed platforms" },
  { icon: HiMiniStar, value: 100, suffix: "%", label: "Client Satisfaction", description: "Repeat clients and positive referrals" },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 glass-card px-3 py-1.5 sm:px-4 sm:py-2 text-xs sm:text-sm text-muted-foreground mb-3 sm:mb-4">
            <HiMiniRocketLaunch className="text-primary" size={14} /> Real Results
          </div>
